      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Tabs defaultValue="snake" className="w-full">
          ...
          <TabsContent value="racinglimits">
            <ExternalGameEmbed
              src="https://racinglimits.com/racinglimitsgamefile/racing-limits/"
              title="Racing Limits"
              developer="TBG95"
              description="Test your racing prowess to the limit! Race through urban and highway traffic with realistic physics, precise controls, and multiple camera views. Features Career, Unlimited, Against-Time, and Free modes."
            />
          </TabsContent>
